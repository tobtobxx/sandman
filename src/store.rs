...
use crate::domain::{
    CallId, CallStatus, ChannelId, ChannelKind, ChannelRecord, Incoming, Lesson, LessonId, LlmCall,
    Message, NewCall, NewLesson, NewSession, NewTask, Reflection, Run, RunId, Session, SessionId,
    SessionStatus, Spend, Task, TaskId, TaskResult, TaskState, TaskSummary, Timestamp, Utterance,
};
...
impl Store {
    ...
    pub fn create_task(&self, _new: NewTask, _now: Timestamp) -> Result<TaskId, StoreError> {
        unimplemented!()
    }
    ...
    pub fn cancel_tasks(&self, _ids: &[TaskId], _now: Timestamp) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    pub fn task_state(&self, _id: TaskId) -> Result<Option<TaskState>, StoreError> {
        unimplemented!()
    }
    ...
    pub fn next_pending(&self, _now: Timestamp) -> Result<Option<Task>, StoreError> {
        unimplemented!()
    }

    /// How long until the earliest scheduled Task can run, if one is waiting.
    pub fn next_due_in(&self, _now: Timestamp) -> Result<Option<crate::domain::Duration>, StoreError> {
        unimplemented!()
    }
    ...
    pub fn list_tasks(&self, _filter: ListFilter) -> Result<Vec<TaskSummary>, StoreError> {
        unimplemented!()
    }
    ...
    pub fn start_session(&self, _new: NewSession, _now: Timestamp) -> Result<SessionId, StoreError> {
        unimplemented!()
    }

    pub fn set_status(&self, _id: SessionId, _status: SessionStatus) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    pub fn append_message(&self, _id: SessionId, _message: Message) -> Result<usize, StoreError> {
        unimplemented!()
    }
    ...
    pub fn record_reflection(&self, _id: SessionId, _r: Reflection) -> Result<(), StoreError> {
        unimplemented!()
    }

    /// The most recent metacognition, whichever kind — what the interrupt counts
    /// from.
    pub fn last_reflection(&self, _id: SessionId) -> Result<Option<Reflection>, StoreError> {
        unimplemented!()
    }

    pub fn session(&self, _id: SessionId) -> Result<Option<Session>, StoreError> {
        unimplemented!()
    }

    /// Put something in a Comms Session's mailbox.
    pub fn receive_mail(&self, _id: SessionId, _incoming: Incoming) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    pub fn take_mail(&self, _id: SessionId) -> Result<Vec<Incoming>, StoreError> {
        unimplemented!()
    }
    ...
    pub fn queue_call(&self, _new: NewCall, _now: Timestamp) -> Result<CallId, StoreError> {
        unimplemented!()
    }

    pub fn set_call_status(&self, _id: CallId, _status: CallStatus) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    pub fn say(&self, _channel: ChannelId, _utterance: Utterance) -> Result<(), StoreError> {
        unimplemented!()
    }

    pub fn transcript(&self, _channel: ChannelId) -> Result<Vec<Utterance>, StoreError> {
        unimplemented!()
    }
    ...
    pub fn channel_session(&self, _channel: ChannelId) -> Result<Option<SessionId>, StoreError> {
        unimplemented!()
    }

    // --- Lessons -----------------------------------------------------------

    pub fn keep_lesson(&self, _new: NewLesson, _now: Timestamp) -> Result<LessonId, StoreError> {
        unimplemented!()
    }
    ...
    pub fn vector(&self, _key: &str, _model: &str) -> Result<Option<Vec<f32>>, StoreError> {
        unimplemented!()
    }

    pub fn put_vector(&self, _key: &str, _model: &str, _v: &[f32]) -> Result<(), StoreError> {
        unimplemented!()
    }
