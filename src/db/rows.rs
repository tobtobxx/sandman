...
use super::DbError;
use crate::domain::{
    CallStatus, ChannelRecord, Incoming, LessonSubject, LlmCall, Message, Reflection,
    ReflectionResult, Run, Schedule, Session, SessionId, Task, TaskState, Utterance,
};
...
pub fn task_state_from_row(_tag: &str, _json: &str) -> Result<TaskState, DbError> {
    unimplemented!()
}
...
pub fn call_status_from_row(_tag: &str, _json: &str) -> Result<CallStatus, DbError> {
    unimplemented!()
}

pub fn reflection_result_to_row(_r: &ReflectionResult) -> Result<Tagged, DbError> {
    unimplemented!()
}

pub fn reflection_result_from_row(_tag: &str, _json: &str) -> Result<ReflectionResult, DbError> {
    unimplemented!()
}
...
pub fn lesson_subject_from_row(_tag: &str, _json: &str) -> Result<LessonSubject, DbError> {
    unimplemented!()
}
...
/// order.
pub fn load_session(_tx: &Transaction<'_>, _id: SessionId) -> Result<Option<Session>, DbError> {
    unimplemented!()
}
