...
impl Harness {
    ...
    /// the next one back.
    async fn complete_task(&self, _id: TaskId, _result: TaskResult) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    pub async fn cancel_task(&self, _id: TaskId) -> Result<CancelOutcome, StoreError> {
        unimplemented!()
    }
    ...
    pub fn open_channels(&self) -> Vec<(ChannelId, crate::domain::ChannelKind)> {
        unimplemented!()
    }
    ...
    pub async fn run(self: &Arc<Self>, _drive: Drive) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    pub async fn run_until_idle(self: &Arc<Self>, _drive: Drive) -> Result<(), StoreError> {
        unimplemented!()
    }
    ...
    async fn drive_worker(self: &Arc<Self>, _session: SessionId, _task: TaskId) {
        unimplemented!()
    }
    ...
    pub async fn wind_down(self: &Arc<Self>, _timeout: crate::domain::Duration) {
        unimplemented!()
    }

    /// The context a Session and its tools run against.
    pub fn ctx(self: &Arc<Self>, _session: SessionId) -> crate::session::SessionCtx {
        unimplemented!()
    }
